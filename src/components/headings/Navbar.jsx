...
const Navbar = () => {
  ...
  return (
    <nav className='bg-secondary-color'>
      <div className='container flex items-center justify-between z-10 py-2'>
        <section className='flex items-center gap-x-3'>
          ...
          <div name='heading' className='hidden md:flex'>
            <h5 className='text-sm text-gray-300 flex items-center px-2 gap-x-2 hover:text-white'>
        ...
        <div className='flex items-center mr-3'>
          ...
          {loginData !== '' ? (
            ...
            <button
              className='flex flex-wrap items-center justify-center py-1 px-2 rounded text-[14px] md:px-5 md:py-1'
